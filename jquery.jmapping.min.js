...
$(document).trigger('markerCreated.jMapping',[marker]);});bounds_zoom_level=map.getBoundsZoomLevel(bounds);if(settings.always_show_markers===true){min_zoom=0;}else{min_zoom=(bounds_zoom_level<7)?0:(bounds_zoom_level-7);}
